...
private final String User_AGENT = "Mozilla/5.0";
	...
	public String user_allchampinfo(String id) throws IOException {
		URL lolApisite = new URL("https://kr.api.riotgames.com/lol/champion-mastery/v4/champion-masteries/by-summoner/"+id+"?api_key=RGAPI-5eb7bc0e-9610-4135-842c-f0c766107349");
		URL obj = lolApisite;
